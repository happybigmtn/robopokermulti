...
/// Packed as: [high bits street][10 bits index]
///
...
const INDEX_BITS: u16 = 10;
const INDEX_MASK: u16 = (1u16 << INDEX_BITS) - 1;
const STREET_SHIFT: u16 = INDEX_BITS;
const STREET_MASK: u16 = !INDEX_MASK;
...
impl From<(Street, usize)> for Abstraction {
    fn from((street, index): (Street, usize)) -> Self {
        let hi_bits = (street as u16) << STREET_SHIFT;
